          ...
          <span>
            <span className='imagesOptionsPortion'>
              {images.map((image, index) => (
                <span
                  key={index}
                  className={`imagesOptions ${selectedImageIndex === index ? 'highlighted' : ''}`}
